...
declare class WebHelper extends Helper {
     ...
     */
    addSource(types: Array<any>, urlFunction: UrlFunction): void;
    /**
     ...
     */
    addStore(types: Array<any>, getFunction: UrlFunction, createFunction: UrlFunction, updateFunction: UrlFunction): void;
    /**
